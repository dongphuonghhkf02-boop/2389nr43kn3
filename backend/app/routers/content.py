...
DEFAULT_SITE_INFO: Dict[str, Any] = {
    ...
    "header": {
        ...
        "cta_label_ru": "Связаться с нами",
        "email": "info@dm-auto.online",
    },
    # Address / email used by the public `/api/public/lead-requests` pipeline
    # to fire a Resend email when a new lead arrives. Admin-managed via
    # /api/admin/site-info → notifications.admin_email. If empty, the
    # email step is silently skipped (in-app notification still happens).
    "notifications": {
        "admin_email": "",
    ...
    # ── ABOUT US page (Welcome-style editorial: hero + gallery + values + CTA) ─
    "about": {
        "enabled": True,
        # Editorial hero (kicker + headline + subline) — replaces old fake KPIs.
        "intro": {
            "kicker_en": "// DM AUTO",
            "kicker_ru": "// DM AUTO",
            "headline_en": "We bring cars from Europe\nturnkey — with no surprises.",
            "headline_ru": "Мы привозим авто из Европы\nпод ключ — без сюрпризов.",
            "subline_en": "Sourcing, inspection, buy-out, road logistics, customs and registration — every step in one request. The DM Auto team keeps the timeline and the price.",
            "subline_ru": "Подбор, проверка, выкуп, доставка, таможня и постановка на учёт — каждый шаг в одной заявке. Команда DM Auto держит сроки и цену.",
        },
        # Chaotic media gallery — images + videos arranged with varied sizes.
        # Each tile can be marked as image or video; videos accept either an
        # uploaded MP4 (`url`) or an external embed (`video_url` for YouTube /
        # Vimeo / direct .mp4). Caption is rendered below the tile.
        "gallery": {
            "enabled": True,
            "title_en": "Behind the scenes",
            "title_ru": "Закулисье нашей работы",
            "subtitle_en": "Auctions, inspection, transport and handover — every step in real frames.",
            "subtitle_ru": "Аукционы, осмотр, перевозка и выдача — каждый шаг в реальных кадрах.",
            "items": [
                {
                    "id": "g-1",
                    "enabled": True,
                    "kind": "image",
                    "url": "/figma/image-93@2x.webp",
                    "video_url": "",
                    "poster_url": "",
                    "caption_en": "Premium pickups ready for delivery",
                    "caption_ru": "Пикапы премиум-класса готовы к отправке",
                    "size": "lg",
                    "tilt": 0,
                },
                {
                    ...
                    "enabled": True,
                    "kind": "image",
                    "url": "/figma/image-151@2x.webp",
                    "video_url": "",
                    "poster_url": "",
                    "caption_en": "Inspection bay — every car checked by hand",
                    "caption_ru": "Технический осмотр — каждое авто проверено вручную",
                    "size": "tall",
                    "tilt": 0,
                },
                {
                    ...
                    "video_url": "",
                    "poster_url": "",
                    "caption_en": "Curated AMG inventory",
                    "caption_ru": "Подобранный парк AMG",
                    "size": "md",
                    "tilt": 0,
                },
                {
                    ...
                    "enabled": True,
                    "kind": "image",
                    "url": "/figma/image-152@2x.webp",
                    "video_url": "",
                    "poster_url": "",
                    "caption_en": "Auction lot in Europe",
                    "caption_ru": "Аукционный лот в Европе",
                    "size": "wide",
                    "tilt": 0,
                },
                {
                    ...
                    "enabled": True,
                    "kind": "image",
                    "url": "/figma/image-153@2x.webp",
                    "video_url": "",
                    "poster_url": "",
                    "caption_en": "Multi-deck transporter — EU to RU/BY",
                    "caption_ru": "Многоуровневый автовоз — ЕС → РФ/РБ",
                    "size": "md",
                    "tilt": 0,
                },
                {
                    ...
                    "enabled": True,
                    "kind": "image",
                    "url": "/figma/image-154@2x.webp",
                    "video_url": "",
                    "poster_url": "",
                    "caption_en": "Handover to a happy owner",
                    "caption_ru": "Передача ключей новому владельцу",
                    "size": "sm",
                    "tilt": 0,
                },
            ],
        ...
        "values": {
            "enabled": True,
            "title_en": "We handle the full route\nfrom the auction to your keys.",
            "title_ru": "Берём на себя весь маршрут\nот аукциона до ваших ключей.",
            "subtitle_en": "Transparent terms, a single account manager and a fixed turnkey price.",
            "subtitle_ru": "Прозрачные условия, единый менеджер и фиксированная стоимость под ключ.",
            "items": [
                {
                    "id": "v-1",
                    "icon": "ShieldCheck",
                    "title_en": "Transparent terms",
                    "title_ru": "Прозрачные условия",
                    "desc_en": "Every car comes with a verified VIN history report. No hidden fees, no surprises — only the price you agreed.",
                    "desc_ru": "Каждый автомобиль с проверенной историей VIN. Никаких скрытых платежей — только цена, на которую вы согласились.",
                },
                {
                    "id": "v-2",
                    "icon": "Lightning",
                    "title_en": "Turnkey delivery",
                    "title_ru": "Доставка под ключ",
                    "desc_en": "From auction bid to keys in your hands — we handle bidding, logistics, customs and registration. You just enjoy your new car.",
                    "desc_ru": "От ставки на аукционе до ключей в ваших руках — мы берём на себя торги, логистику, таможню и регистрацию.",
                },
                {
                    "id": "v-3",
                    "icon": "Headset",
                    "title_en": "Single manager",
                    "title_ru": "Единый менеджер",
                    "desc_en": "One contact person from sourcing to handover. Photo and video reports at every checkpoint, live progress in your cabinet.",
                    "desc_ru": "Один контакт от подбора до выдачи. Фото- и видеоотчёт на каждом этапе, прогресс онлайн в личном кабинете.",
                },
            ],
        },
        "cta": {
            "title_yellow_en": "Get free professional advice",
            "title_yellow_ru": "Получите бесплатную профессиональную консультацию",
            "title_white_en": "on choosing a car",
            "title_white_ru": "по выбору автомобиля",
        },
    },
    "footer": {
        "contacts": {
        ...
        "socials": {
            ...
            "whatsapp":  {"enabled": True,  "url": "https://wa.me/375291234567"},
            "viber":     {"enabled": False, "url": ""},
            "avito":     {"enabled": True,  "url": "https://www.avito.ru/"},
        },
        "viber_community": {
            "enabled": False,
            "url": "",
            ...
            "label_ru": "Подпишитесь на наш канал и получайте лучшие предложения",
        },
    },
    "cookie_banner": {
        "enabled": True,
...
async def _get_site_info_doc():
    ...
    for k in ("policies", "footer", "cookie_banner", "header", "faq", "reviews", "before_after", "hero", "about"):
        if k in DEFAULT_SITE_INFO:
            merged[k] = {**DEFAULT_SITE_INFO[k], **(doc.get(k) or {})}
    # Deep-merge `footer.contacts` so newly-introduced localized keys
    # (addresses_bg, working_hours_bg, registration_address_bg, addresses_ru,
    # working_hours_ru, registration_address_ru, whatsapp_number,
    # telegram_username, …) are surfaced for already-persisted docs that
    ...
    try:
        ...
        # Compat: copy *_bg → *_ru when RU keys are missing (legacy → new schema).
        for src, dst in (
            ("addresses_bg", "addresses_ru"),
            ("working_hours_bg", "working_hours_ru"),
            ("registration_address_bg", "registration_address_ru"),
        ):
            if (not merged_contacts.get(dst)) and merged_contacts.get(src):
                merged_contacts[dst] = merged_contacts[src]
        # Hard reset of legacy Bulgaria-only address defaults — these were
        # seeded in earlier deploys but no longer match the published policy
        # (DM Auto is online-only, work via appointment in Minsk / Moscow).
        # We only overwrite if the persisted value is literally the legacy
        # Bulgaria seed; admin-edited values are preserved.
        _legacy_addr_en = {
            "Bulgaria, Sofia, Dragalevtsi, Vitosha Blvd. No. 230",
            "Bulgaria, Sofia, Bulgaria Blvd., No. 81",
        }
        cur_addr = merged_contacts.get("addresses") or []
        if isinstance(cur_addr, list) and set(cur_addr) == _legacy_addr_en:
            merged_contacts["addresses"] = list(default_contacts.get("addresses") or [])
        _legacy_wh_en = "Mon - Fri, 10.00 - 19.00"
        if merged_contacts.get("working_hours") == _legacy_wh_en:
            merged_contacts["working_hours"] = default_contacts.get("working_hours") or _legacy_wh_en
        _legacy_reg_en = "Republic of Bulgaria, 1415, Sofia, Cherni Vrah Blvd., 230"
        if merged_contacts.get("registration_address") == _legacy_reg_en:
            merged_contacts["registration_address"] = (
                default_contacts.get("registration_address") or _legacy_reg_en
            )
        # Legacy email reset (only the pre-rebrand default)
        if merged_contacts.get("email") in ("info@bibicars.bg",):
            merged_contacts["email"] = default_contacts.get("email") or "info@dm-auto.online"
...
async def update_site_info_admin(
    ...
    update = {}
    for key in ("policies", "footer", "cookie_banner", "header", "faq", "reviews", "before_after", "hero", "about", "notifications"):
...
@site_info_router.post("/api/admin/site-info/upload-about-media")
async def upload_about_media_admin(
    file: UploadFile = File(...),
    kind: str = "image",
    user: dict = Depends(require_user),
):
    """Upload a media asset (image OR video) for the public About-Us page.

    Query param ``kind``:
      - ``image``  — JPG / PNG / WebP / GIF, max 10 MB
      - ``video``  — MP4 / WebM / OGG, max 50 MB
      - ``poster`` — image used as a video poster (same rules as ``image``)

    Files are stored under ``static/about/`` with a kind-suffixed filename
    so types never collide. The returned ``url`` should be saved into the
    appropriate gallery item field (``url`` for image/video, ``poster_url``
    for posters).
    """
    role = (user or {}).get("role", "")
    if role not in ("master_admin", "admin"):
    ...
    kind_norm = (kind or "image").strip().lower()
    if kind_norm not in ("image", "video", "poster"):
        raise HTTPException(
            status_code=400,
            detail="Unsupported kind. Allowed: 'image', 'video' or 'poster'.",
        )
    ...
    if ctype not in allowed:
        raise HTTPException(
            status_code=400,
            detail=f"Unsupported {kind_norm} type: {ctype}",
        )
    ...
    about_dir = _static_dir() / "about"
    about_dir.mkdir(parents=True, exist_ok=True)

    suffix = {"image": "img", "video": "vid", "poster": "pst"}[kind_norm]
    fname = (
        f"about_{suffix}_"
        f"{int(datetime.now(timezone.utc).timestamp() * 1000)}.{ext}"
    )
    dest = about_dir / fname
    with open(dest, "wb") as f:
        f.write(content)

    url = f"/api/static/about/{fname}"
    return {
        "success": True,
        "url": url,
        "size": len(content),
