...
const NAV = [
  // 2026-06 pivot: "CATALOG" removed — curated picks live on home page.
    ...
    >
      ...
      >
        <a
          ...
          style={{ height: 34, paddingRight: '5.4px' }}
        >
          <img
      ...
      <div className="px-4 pt-5 pb-12 flex flex-col">
        ...
        <a
          ...
          className="relative flex items-center justify-center w-full text-center uppercase rounded hover:brightness-110 transition gap-2"
          style={{
            height: 56,
            background: '#162E51',
            color: '#FFFFFF',
