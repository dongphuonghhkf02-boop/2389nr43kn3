...
const WA = (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.477 2 2 6.477 2 12c0 1.767.46 3.43 1.265 4.875L2 22l5.25-1.235A9.957 9.957 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm-2.66 5.43c.24 0 .49-.01.7.01.21.02.47.05.77.78.32.78.95 2 1.03 2.14.08.14.13.32.02.51-.11.21-.17.34-.34.52-.18.18-.37.41-.53.55-.18.16-.36.34-.16.66.2.32.9 1.48 1.93 2.4 1.33 1.18 2.45 1.55 2.79 1.72.34.18.54.15.74-.09.2-.24.85-.99 1.07-1.33.22-.34.45-.28.75-.17.31.11 1.97.93 2.31 1.1.34.17.57.25.65.4.08.14.08.85-.21 1.66-.29.81-1.43 1.55-2.13 1.65-.55.08-1.24.12-2-.13-.49-.16-1.12-.36-1.92-.71-3.39-1.45-5.62-4.83-5.79-5.05-.17-.23-1.43-1.9-1.43-3.63s.9-2.58 1.22-2.93c.32-.35.7-.43 1-.43z"/>
  </svg>
);
const TG = (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const ShareModal = ({ open, onClose, vin, snapshot }) => {
  ...
  const openChannel = useCallback(async (channel) => {
    ...
    if (channel === 'facebook') {
      ...
      // wa.me universal share — works on desktop + mobile.
      target = `https://wa.me/?text=${encodedText}${encodedUrl}`;
