...
async def ensure_customer_seed(customer_id: str):
    ...
    # 7. Notifications — реальная логика для DM Auto (промо/новинки/обновления каталога)
    # Без аукционов, договоров и доставок — этих сущностей в кабинете нет.
        ...
        await _db().notifications.insert_many([
            {
                ...
                'customerId': customer_id,
                'title': '🚗 Добро пожаловать в DM Auto!',
                'message': 'Спасибо за регистрацию. Просмотрите подборку недели — лучшие авто из Европы и США уже ждут вас.',
                'type': 'welcome',
                'link': '/',
                'isRead': False,
            ...
            },
            {
                ...
                'customerId': customer_id,
                'title': '🔥 Подборка недели обновлена',
                'message': 'В каталоге появились новые автомобили от 12 000 €. Загляните в раздел «Подборка недели».',
                'type': 'catalog_update',
                'link': '/#deals-budget-filter',
                'isRead': False,
            ...
            },
            {
                ...
                'customerId': customer_id,
                'title': '💡 Совет: используйте «Избранное»',
                'message': 'Сохраняйте понравившиеся авто в Избранное, чтобы быстро вернуться к ним позже.',
                'type': 'tip',
                'link': f'/cabinet/{customer_id}/favorites',
                'isRead': True,
            ...
            },
            {
                ...
                'customerId': customer_id,
                'title': '📊 Сравнивайте до 3 авто одновременно',
                'message': 'Добавляйте автомобили в раздел «Сравнение», чтобы выбрать лучший вариант.',
                'type': 'tip',
                'link': f'/cabinet/{customer_id}/compare',
                'isRead': True,
